<div id="page-content-wrapper">
    <div id="page-content" style="margin-bottom: 50px;">
        <h3 class="page-title" id="business-info"><u>New SubCategory:</u>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="<?php echo APP_URL;?>subcategory/create" id="form1">
                    <div class="row form-group">
                        <div class="col-md-4">
                            <label>SubCategory Name</label><em>*</em>
                            <input type="text" name="sub_category_name" id="sub_category_name" class="form-control" value="<?php echo @$_POST['sub_category_name'];?>">
                        </div>
                    </div> 
                    <div class="row form-group">
                        <div class="col-md-4">
