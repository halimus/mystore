...
class bootstrap {
    ...
    private function _loadExistingController() {
        ...
        if (file_exists($file)) {
            ...
            //if($this->_url[0] == $this->_adminFolder ){
               //$this->_controller->loadModel($this->_url[0], $this->_modelPathAdmin);
            //}
            //else $this->_controller->loadModel($this->_url[0], $this->_modelPath);
