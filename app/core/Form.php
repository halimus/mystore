...
class Form {
     ...
     * Règle de validation pour chaque valuechamps 
      '0':    // Optionel
      '1':    // Non vide (Obligatoire)
      '2':    // Lettres seulement accepté
      '3':    // Chiffres seulement accepté
      '4':   //  Adresse mail
      '5':   //  Validité d'une date aaaa-mm-jj 
      '6':   //  Longeur >= 4 caractéres
      '7':   //  Validité du téléphone (DZ)
      '8':   //  Validité du mobile (DZ)
      '9':   //  No blank inside (username)
      '10':  //  must containt this $special_cars (au debut) d-
      '11':  //  must not contain $special_cars (au debut) d-
      '12':   //  Longeur <= 200 caractéres
     */
